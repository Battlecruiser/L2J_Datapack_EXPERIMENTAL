...
import com.l2jserver.gameserver.instancemanager.AwakeningManager; // rocknow-God-Awaking
...
public class AdminSkill implements IAdminCommandHandler
{
	...
	private void adminGiveAllSkills(L2PcInstance activeChar, boolean includedByFs)
	{
		...
		AwakeningManager.getInstance().AwakingRemoveSkills(player); // rocknow-God-Awaking
